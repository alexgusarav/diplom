...
**7. Перед началом установки новых приложений обновите списки пакетов в системе:**
```
apt-get update
```

**8.Затем установите необходимые для дальнейшей работы зависимости:**
```
apt-get install ca-certificates curl gnupg
```

**9. устанавливите GPG-ключ, который будет использоваться пакетным менеджером apt для проверки подлинности пакетов из репозитория Docker**
```
...
**10.добавьте в систему APT-репозиторий Docker**
```
echo \
...
**11.обновите список пакетов через загрузку index-файлов с каждого подключённого репозитория**
```
apt-get update
```

**12. установите Docker**
```
apt-get install docker.io docker-compose docker-compose-plugin docker-buildx-plugin -y
```

**13. Запускаем контейнеры db, backend, frontend**
```
docker compose up -d
```

**14. применяем миграции в БД**
```
